...
String contrasenaCerradura = "01020304*";   //Variable donde almaceno la contraseña definida por el sistema
...
void loop()
{
     ...
     while(Serial.available()>0)
  {
    ...
    info_recibida2= info_recibida2+key2;
              
  }
    keym= key+info_recibida2;
    info_recibida2=0;
    info_recibida = info_recibida + keym;
    Serial.println(keym);
